...
%             end
        ...
        if food_least - food_now >0 && water_least - water_now >0
               %此时都缺
               money_now = money_now - 20*(food_least - food_now) - 10*(water_least - water_now);
               food_now = food_least;
               water_now = water_least;
       elseif food_least - food_now >0 && water_least - water_now <0
        ...
        elseif food_least - food_now <0 && water_least - water_now >0
               ...
               money_now = money_now - 20*(water_least - water_now);
               water_now = water_least;
        end
        for kk = tempnum2 : col
            if weather == 3
